...
function ShoppingListing(){
    ...
    return <div className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-6 p-4 md:p-6">
        ...
        <div className="bg-background w-full rounded-lg shadow-sm"> 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-col-4  pt-[20px]">  
                    {
